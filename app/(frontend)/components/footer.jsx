...
const Footer = () => {
    return (
        <footer className="relative bg-white border-t border-gray-100 pt-20 pb-10 overflow-hidden">
            {/* Background Accent */}
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-primary opacity-5 blur-[100px] rounded-full pointer-events-none"></div>
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                    ...
                    <div className="flex flex-col items-center text-center">
                        <h3 className={`text-xl text-text font-bold mb-8 tracking-widest ${cinzel.className}`}>
                            Follow Us
                        </h3>
                    ...
                    <div className="flex flex-col items-center md:items-end text-center md:text-right">
                        ...
                        <ul className={`space-y-4 text-gray-600 ${manrope.className}`}>
                            <li className="flex items-center gap-3 justify-center md:justify-end">
                                <span>Indore, Madhya Pradesh, Bharat (452018)</span>
                                <MapPin size={18} className="text-primary" />
                            </li>
                            <li className="flex items-center gap-3 justify-center md:justify-end">
                                <a href="mailto:livehealthybesafe@gmail.com" className="hover:text-primary transition-colors">
                                    livehealthybesafe@gmail.com
                                </a>
                                <Mail size={18} className="text-primary" />
                            </li>
                            <li className="flex items-center gap-3 justify-center md:justify-end">
                                <a href="tel:+919713600085" className="hover:text-primary transition-colors">
                                    +91 9713600085
                                </a>
                ...
                <div className={`border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500 ${manrope.className}`}>
                    ...
                    <div className="flex gap-6">
                        <a href="/refundpolicy" className="hover:text-primary transition-colors">Refund Policy</a>
                        <a href="/termsandconditions" className="hover:text-primary transition-colors">Terms & Conditions</a>
                    </div>
                </div>
            </div>
        </footer>
