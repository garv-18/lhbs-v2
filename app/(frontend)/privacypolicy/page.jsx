  ...
  return (
    <div className={`max-w-4xl mx-auto px-6 pt-32 pb-20 min-h-screen text-text ${manrope.className}`}>
      ...
      <div className="space-y-8 text-gray-700 leading-relaxed">
        ...
        <div>
          <h2 className={`text-2xl font-bold mb-4 text-black ${cinzel.className}`}>Sharing</h2>
          <p>
        ...
        <div>
          <h2 className={`text-2xl font-bold mb-4 text-black ${cinzel.className}`}>Security Precautions</h2>
          <p>
        ...
        <div>
          <h2 className={`text-2xl font-bold mb-4 text-black ${cinzel.className}`}>Data Deletion and Retention</h2>
          <p>
        ...
        <div>
          <h2 className={`text-2xl font-bold mb-4 text-black ${cinzel.className}`}>Your Rights</h2>
          <p>
        ...
        <div>
          <h2 className={`text-2xl font-bold mb-4 text-black ${cinzel.className}`}>Consent</h2>
          <p>
        ...
        <div>
          <h2 className={`text-2xl font-bold mb-4 text-black ${cinzel.className}`}>Changes to this Privacy Policy</h2>
          <p>
        ...
        <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 mt-10">
          <h2 className={`text-xl font-bold mb-4 text-black ${cinzel.className}`}>Contact Us</h2>
          <div className="space-y-2 text-sm text-gray-700">
            <p className="font-semibold text-base mb-3">Live Healthy and Be Safe</p>
            <p>267, Goyal nagar, Near Bangali square</p>
            <p>Indore MP 452018</p>
            <p className="mt-4"><strong>Phone:</strong> Time: Monday – Friday (9:00 – 18:00)</p>
            <p><strong>Contact Person:</strong> Pramod Goswami</p>
          </div>
        </div>
      </div>
    </div>
